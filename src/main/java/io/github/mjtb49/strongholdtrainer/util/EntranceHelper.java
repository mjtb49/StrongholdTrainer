...
public final class EntranceHelper {
    ...
    public static void addLeft(Direction direction, List<EntryNode> entrances, BlockBox boundingBox, int i, int j, EntryNode.Type type) {
        switch(direction) {
            ...
            case WEST:
                entrances.add(new EntryNode(new BlockBox(
                        new BlockPos(boundingBox.minX + j, boundingBox.minY + i, boundingBox.minZ - 1 + 1),
                        new BlockPos(boundingBox.minX + j + 3, boundingBox.minY + i + 3, boundingBox.minZ - 1)
                ), type));
                break;
            case EAST:
                entrances.add(new EntryNode(new BlockBox(
    ...
    public static void addRight(Direction direction, List<EntryNode> entrances, BlockBox boundingBox, int i, int j, EntryNode.Type type) {
        switch(direction) {
            ...
            case WEST:
                entrances.add(new EntryNode(new BlockBox(
                        new BlockPos(boundingBox.minX + j, boundingBox.minY + i, boundingBox.maxZ + 1 + 1),
                        new BlockPos(boundingBox.minX + j + 3, boundingBox.minY + i + 3, boundingBox.maxZ + 1)
                ), type));
                break;
            case EAST:
                entrances.add(new EntryNode(new BlockBox(
